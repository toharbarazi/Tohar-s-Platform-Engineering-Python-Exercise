...
def create_ec2():
    ...
    if config[0]["instance_type"] == "t4g.nano":
        ami_id = amazon_image_arm64 if config[0]["ami_choice"] == "2" else ubuntu_image_arm64
    else:
        ami_id = amazon_image_x86_64 if config[0]["ami_choice"] == "2" else ubuntu_image_x86_64

    ec2_instance = aws.ec2.Instance(
        config[0]["name"],
        ami=ami_id,
        instance_type=config[0]["instance_type"],
        tags={
            "Name": config[0]["name"],
